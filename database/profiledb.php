<?php     
    ...
    echo '<div>
          <form action="" method="post" class="form-horizontal" id="accountSetForm" role="form" enctype="multipart/form-data">
        ...
        // echo $image_name.$image_tmp_name.$name.$email.$phone.$user;        
        if($name != $user){
            if($image_name != ''){
                if($image_size <= 40000){                    
